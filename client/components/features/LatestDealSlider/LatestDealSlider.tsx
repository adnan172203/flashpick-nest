...
// components/LatestDealSlider.js
'use client';
...
import { dealSlidesData } from '@/components/features/LatestDealSlider/constants/dealSlideData';
import { swiperParams } from './constants/dealSwiperConfig';

const LatestDealSlider = () => (
  <section className='relative pt-15px pl-10px md:p-5 md:pb-0 md:pr-0'>
    <div className='w-full h-2/4 bg-#FAFAFA absolute left-0 bottom-0'></div>
    <Swiper {...swiperParams}>
      {dealSlidesData.map((slide, index) => (
