...
const swiperParams = {
  ...
  navigation: {
    nextEl: '.next-productSlider-2',
    prevEl: '.prev-productSlider-2',
  },
  breakpoints: {
    0: {
      slidesPerView: 1,
      ...
      <div className='w-full xl:max-w-[49%]'>
        <div className='flex gap-5 items-center justify-between bg-white px-10px md:px-5 py-3 mb-4'>
          <h2 className='h2-title2 text-#17201D'>
            <span>Winter’s</span> Apparel
          </h2>
          {/* <!-- swiper nav btns  --> */}
          <div className='flex gap-5px items-center justify-between'>
            <button className='relative prev-productSlider-2 text-#17201D hover:text-white hover:bg-#17201D rounded-full w-7 h-7'>
              <svg
            ...
            <button className='relative next-productSlider-2 text-#17201D hover:text-white hover:bg-#17201D rounded-full w-7 h-7'>
              <svg
                className='w-4 h-4 absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4'
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 12 12'
        ...
        <div className='px-10px md:px-0'>
          <div className='swiper productSlider productSlider-2'>
            <div className='swiper-wrapper'>
              <Swiper {...swiperParams}>
                <SwiperSlide>
                  {/* <!-- swiper slide, radioGroup-1  --> */}
                  <div className='swiper-slide'>
                    {/* <!-- product card type 2 , product name, cardProductthcolor --> */}
                    <div className='group/product card-container'>
                      {/* <!-- badge  --> */}
                      <span className='badge-sale'>sale</span>
                      {/* <!-- product image, category, title, colors  --> */}
                      <div className='card-block-1 product-images-swatch group-hover/product:border-#F2F2F2'>
                        {/* <!-- image --> */}
                        <div className='h-full flex justify-center items-end mb-5px'>
                        ...
                        <div className='card-space'>
                          ...
                          <h3 className='card-title'>
                            <a href='product-details-1.html'>
                              Men’s Casual Winter Hoodie with 22 number design
                            </a>
                          </h3>
                      ...
                      <div className='card-block-2 group-hover/product:border-transparent'>
                        ...
                        <div className='group-hover/product:hidden h-full flex flex-col justify-center'>
                          ...
                          <div className='flex items-end gap-1'>
                            {/* <!-- sale price  --> */}
                            <span className='card-price-sale'>$ 203.00</span>
                            {/* <!-- price  --> */}
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_71_128'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_72_129'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
                ...
                <SwiperSlide>
                  {/* <!-- swiper slide, radioGroup-2  --> */}
                  <div className='swiper-slide'>
                    {/* <!-- product card type 2 , product name, cardProductthcolor --> */}
                    <div className='group/product card-container'>
                      {/* <!-- badge  --> */}
                      <span className='badge-best-selling'>best selling</span>
                      {/* <!-- product image, category, title, colors  --> */}
                      <div className='card-block-1 product-images-swatch group-hover/product:border-#F2F2F2'>
                        {/* <!-- image  --> */}
                        <div className='h-full flex justify-center items-end mb-5px'>
                        ...
                        <div className='card-space'>
                          ...
                          <h3 className='card-title'>
                            <a href='product-details-1.html'>
                              Women’s Casual Black Winter Hoodie
                            </a>
                          </h3>
                      ...
                      <div className='card-block-2 group-hover/product:border-transparent'>
                        ...
                        <div className='group-hover/product:hidden h-full flex flex-col justify-center'>
                          ...
                          <div className='flex items-end gap-1'>
                            {/* <!-- sale price  --> */}
                            <span className='card-price-sale'>$ 206.00</span>
                            {/* <!-- price  --> */}
                            <span className='card-price-original'>
                              {' '}
                              $300.00{' '}
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_73_130'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_74_131'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
                    ...
                    <div className='group/product card-container'>
                      ...
                      <div className='card-block-1 product-images-swatch group-hover/product:border-#F2F2F2'>
                        ...
                        <div className='card-space'>
                          ...
                          <h3 className='card-title'>
                            <a href='product-details-1.html'>
                              Women’s Casual White Polo shirt for winter
                            </a>
                          </h3>
                          ...
                          <div className='mt-10px flex items-center w-14 justify-between'>
                            <input
                              type='radio'
                              checked
                              className="relative appearance-none w-3 h-3 rounded-full cursor-pointer bg-#E2DECD checked:text-#E2DECD checked:bg-#E2DECD checked:ring-1 checked:ring-black ring-offset-2 active:ring-black border-none before:absolute before:w-3 before:h-3 before:bg-#E2DECD before:content-[''] before:top-2/4 before:left-2/4 before:[transform:translate(-50%,-50%)] before:rounded-full"
                              name='radioGroup-3'
                            />
                            <input
                              type='radio'
                              className="relative appearance-none w-3 h-3 rounded-full cursor-pointer bg-#D47869 checked:text-#D47869 checked:ring-1 checked:ring-black ring-offset-2 active:ring-black border-none before:absolute before:w-3 before:h-3 before:bg-#D47869 before:content-[''] before:top-2/4 before:left-2/4 before:[transform:translate(-50%,-50%)] before:rounded-full"
                              name='radioGroup-3'
                            />
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_75_132'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_76_133'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_77_134'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_78_135'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_79_136'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_80_137'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
                        ...
                        <div className='group-hover/product:flex card-qfc'>
                          ...
                          <div className='group/qfc card-qfc-wrapper'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4095_81_138'>
                                  <rect
                                    width='16'
                                    height='16'
                                    fill='white'
                          ...
                          <div className='group/qfc card-qfc-wrapper open-compare-modal'>
                            ...
                            >
                              ...
                              <defs>
                                <clipPath id='clip0_1_4156_82_139'>
                                  <rect
                                    width='16'
                                    height='12'
                                    fill='white'
