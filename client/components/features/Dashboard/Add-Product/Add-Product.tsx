        ...
        <div className='flex flex-col 2xl:flex-row gap-6'>
          ...
          <div className='flex-auto space-y-6'>
            ...
            <div className='flex flex-col md:flex-row gap-6'>
              ...
              <div className='w-full'>
                <h3 className='text-xs md:text-sm leading-15px text-#8B8582 pb-3 inline-block select-none'>
                  Size
                </h3>
                <div className='size-selector space-x-2 font-medium text-xs leading-3 tracking-[0.6px] text-#17201D'>
